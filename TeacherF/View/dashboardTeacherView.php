...
if (empty($_SESSION['username'])) {
 header('Location:loginTeacherView.php');
    ...
    echo "<div style='float: right;font-size:20px;margin-top:60px;margin-right: 40px;color:white;';>"." Logged in as&nbsp; <a class='button1' href='viewProfileTeacherView.php'>".$_SESSION['username']."</a> | ";
