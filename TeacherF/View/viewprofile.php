...
<tr>
<td>
<img src="data:image/jpeg;base64,'.base64_encode($image ).'" height="300" width="250" class="img-thumnail" />
</td>
</tr>
</center>
';
...
<table >
   <tr style="border:1px black;" >
    ...
    echo '<br> <a class="button2" href="profilePicture.php"><b>Change profile Picture</b></a><br>' ;
