   ...
   <script>
    ...
    function checkName() {
      if (document.getElementById("name").value == "") {
          ...
          document.getElementById("name").style.borderColor = "red";
          document.getElementById("nameErr").style.color = "red";
        document.getElementById("nameErr").innerHTML = "Name has to be atleast 2 words!";
      }
      else{
      ...
      if (document.getElementById("username").value == "") {
          ...
          document.getElementById("username").style.borderColor = "red";
          document.getElementById("userNameErr").style.color = "red";
        document.getElementById("userNameErr").innerHTML = "Name has to be atleast 2 characters!";
      }else{
...
<h2>Registration</h2><hr><br>
  Name:<br></br><input type="text" name="name" id="name" onkeyup="checkName()" onblur="checkName()" placeholder="Name" ><i class="fa fa-user "></i>
 ...
 User Name:<br></br><input type="text" name="username" id="username" onkeyup="checkuserName()" onblur="checkuserName()" placeholder="Username" ><i class="fa fa-user "></i>


 <span style="color: red; class="error" id="userNameErr"><?php if (!empty($_GET['userNameErr'])) {echo $_GET['userNameErr'];} ?> </span>
   <span  id="availability" ></span><br>
<br>
   
Password:<br></br><input type="password" name="password" id="password" onkeyup="checkPass()" onblur="checkPass()" placeholder="Password"><i class="fa fa-lock icon"></i>
<span id="passwordErr"></span>
<span style="color: red;class="error"><?php if (!empty($_GET['passwordErr'])) {echo $_GET['passwordErr'];} ?> </span>
  <br>
  <br>
  
  Confirm Password:<br></br><input type="password" name="confirmpassword" id="confirmpassword" onkeyup="checkconPass()" onblur="checkconPass()" placeholder="Confirm Password"><i class="fa fa-lock icon"></i>
  ...
  Date of Birth:<br></br> <input type="date" size="1" id="birth" max="2014-05-20"  name="birth"  onkeyup="checkAge()" onblur="checkAge()" ><i class="fa fa-calendar"></i>
