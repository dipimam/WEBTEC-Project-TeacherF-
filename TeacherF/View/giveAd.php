...
if (empty($_SESSION['username'])) 
{
  ...
  echo "<div style='float: right';>"." Logged in as <a href='viewProfileTeacherView.php'>".$_SESSION['username']."</a> | ";
  echo "<a href='../controller/logoutTeacherController.php'>Logout</a><br>";
...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
     <style>
       body { background-image: url('../Sources/dashboardcover.jpg');
...
<div class='sidenav'>
      ...
      <div style="float: left; text-align: left;">
       <a href="dashboardTeacherView.php">Dashboard</a><br><br>
      
      <a href="viewProfileTeacherView.php">Profile</a><br><br>
      
      <a href="changePasswordTeacherView.php">Change Password</a><br><br>
     
      <a href="giveAd.php">Post Ad</a><br><br>
      
       
       <a href="../Controller/logoutTeacherController.php">Logout</a>
    </div>

  </div>
    <center>

 <div style="text-align:center; margin-left:400px;float: middle;">
  <div class="form">
<form name="myform"  method="post" onsubmit="validateform()" action="../controller/postad.php">
  <p> User Name:</p><br> <input type="text" id="username" name="username" onkeyup="checkUsername()" onblur="checkUsername()" placeholder="User Name">
   <span id="usernameErr"></span>
  <span style="color: red;class="error"><?php if (!empty($_GET['usernameErr'])) {echo $_GET['usernameErr'];} ?> </span>
  <br><br>

  <p> E-mail:</p><br> <input type="text" id="email" name="email" onkeyup="checkEmail()" onblur="checkEmail()"  placeholder="Email">
   <span id="emailErr"></span>
  <span style="color: red;class="error"><?php if (!empty($_GET['emailErr'])) {echo $_GET['emailErr'];} ?> </span>
  <br><br>

 <p> Which course you want  help? </p> <input type="text" name="course" id="course" onkeyup="showHint(this.value)" onkeyup="checkCourse()" onblur="checkCourse()"  placeholder="Course">
 ...
 <span style="color: red;class="error"><?php if (!empty($_GET['courseErr'])) {echo $_GET['courseErr'];} ?> </span>
  ...
  <p> Details:</p> <input type="text" name="details" size="40" id="details" onkeyup="checkDetails()" onblur="checkDetails()" placeholder="Details">
  ...
  <br><br>
    ...
    <input type="reset" style="color: blue;">
</form></div>
</div>
</center>
